...
public class SwaggerConfig {
    ...
    public Docket getDocket(){
        ...
        //配置接口的过滤start
        docket.select()
                .apis(RequestHandlerSelectors.basePackage("com.sso.controller"))//根据报名匹配接口的展示
    ...
    public ApiInfo setApiInfo(){
        ...
        Contact contact=new Contact("孟慧康","http://www.baidu.com","598489374@qq.com");
